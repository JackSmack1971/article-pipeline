...
def compute_claim_metrics(grade: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "citation_support_rate": len(citation_supported) / cited_count if cited_count else 1.0,
        ...
        "hard_guardrail_pass": not integrity_violations and not stale_or_contradicted,
    }
